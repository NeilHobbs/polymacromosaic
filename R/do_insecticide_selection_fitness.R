do_insecticide_selection_fitness = function(sim.array,
  ...
  update.after.selection = sim.array[xcoord, ycoord, insecticide, generation-1, "migration"] + do_breeders_equation(male.exposure = male.exposure.landscape[xcoord, ycoord],
                                                                                                                    female.exposure = female.exposure.landscape[xcoord, ycoord],
                                                                                                                    heritability = heritability.landscape[xcoord, ycoord],
                                                                                                                    exposure.scaling.factor = exposure.scaling.factor) - (fitness.cost.landscape[xcoord, ycoord] *do_breeders_equation(male.exposure = male.exposure.landscape[xcoord, ycoord],
                                                                                                                                                                                                                                       female.exposure = female.exposure.landscape[xcoord, ycoord],
                                                                                                                                                                                                                                       heritability = heritability.landscape[xcoord, ycoord],
